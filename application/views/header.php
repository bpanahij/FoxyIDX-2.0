<div id="header" class="clearfix">
    <div class="container_12">
        <div class="grid_12" id="header-container">
            ...
            <ul class="sf-menu">
                <?php
                foreach($menu_items as $top_index => $menu) {
                    ?>
                <li>
                    <a href="<?php echo $menu[0]; ?>"><?php echo $top_index; ?></a>
                    <?php if(count($menu) > 1) { ?>
                    <ul>
                        <?php foreach($menu as $sub_index => $href) {
                        if($sub_index === 0) {
                            continue;
                        }
                        ?>
                        <li><a href="<?php echo $href; ?>"><?php echo $sub_index; ?></a></li>
                        <?php } ?>
                    </ul>
                    <?php } ?>
                </li>
